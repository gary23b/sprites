...
import (
	spritesmodels "github.com/gary23b/sprites/spritesmodels"
...
func (_m *ClickOnBody) Clone() spritesmodels.ClickOnBody {
	ret := _m.Called()
	...
	var r0 spritesmodels.ClickOnBody
	if rf, ok := ret.Get(0).(func() spritesmodels.ClickOnBody); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(spritesmodels.ClickOnBody)
		}
	}
...
func (_c *ClickOnBody_Clone_Call) Return(_a0 spritesmodels.ClickOnBody) *ClickOnBody_Clone_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *ClickOnBody_Clone_Call) RunAndReturn(run func() spritesmodels.ClickOnBody) *ClickOnBody_Clone_Call {
	_c.Call.Return(run)
	return _c
}
